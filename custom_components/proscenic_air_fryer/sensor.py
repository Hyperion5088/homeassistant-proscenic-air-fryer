    ...
    async_add_entities(
        [
            ...
            ProscenicAirFryerSensor(
                ...
                "Device ID",
                "mdi:identifier",
                lambda data: coordinator.entry.data.get(CONF_DEVICE_ID),
                entity_category=EntityCategory.DIAGNOSTIC,
                enabled_default=False,
            ),
            ProscenicAirFryerSensor(
            ...
            ProscenicAirFryerSensor(
                ...
                "Product ID",
                "mdi:barcode",
                lambda data: coordinator.entry.data.get("product_id"),
                entity_category=EntityCategory.DIAGNOSTIC,
                enabled_default=False,
            ),
            ProscenicAirFryerSensor(
                ...
                "Tuya Category",
                "mdi:tag-outline",
                lambda data: coordinator.entry.data.get("category"),
                entity_category=EntityCategory.DIAGNOSTIC,
                enabled_default=False,
            ),
            ProscenicAirFryerSensor(
            ...
            ProscenicAirFryerSensor(
                ...
                "Tuya Region",
                "mdi:earth",
                lambda data: coordinator.entry.data.get(CONF_REGION),
                entity_category=EntityCategory.DIAGNOSTIC,
                enabled_default=False,
            ),
            ProscenicAirFryerSensor(
                ...
                "Tuya UUID",
                "mdi:fingerprint",
                lambda data: coordinator.entry.data.get("uuid"),
                entity_category=EntityCategory.DIAGNOSTIC,
                enabled_default=False,
            ),
            ProscenicAirFryerSensor(
